...
function LoginPage({ setUser }) {
  ...
  return (
    <div className="flex flex-wrap min-h-screen">
      ...
      {/* Form Section */}
      <motion.div
        className="flex items-center justify-center w-full lg:w-1/2 lg:bg-[#1a2238] bg-gray-100 p-4"
        initial={{ opacity: 0, x: 200 }}
        animate={{ opacity: 1, x: 0, transition: { duration: 0.8 } }}
      >
        <motion.form
        ...
        >
          ...
          <button
            ...
            className="w-full bg-[#1a2238] text-white py-2.5 px-4 rounded-lg hover:bg-[#1a2238]transition duration-200 disabled:opacity-60 mb-3"
            disabled={
