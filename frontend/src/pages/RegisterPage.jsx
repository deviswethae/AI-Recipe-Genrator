...
function RegisterPage() {
  ...
  return (
    <div className="flex flex-wrap min-h-screen">
      {/* Form Section */}
      <motion.div
        className="flex items-center justify-center w-full lg:w-1/2 lg:bg-[#1a2238] bg-[#1a2238]"
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-[#1a2238] text-white py-2 px-4 rounded-lg hover:bg-[#1a2238] transition duration-200 disabled:opacity-60"
            disabled={
          ...
          >
            {loading ? (
              <div className="flex justify-center items-center space-x-2">
                <div class="w-8 h-8 border-4 border-t-[#1a2238] border-white rounded-full animate-spin"></div>
                <span>Creating...</span>
              </div>
            ) : (
              "Create Account"
