...
const RecipeCard = ({
  ...
  return (
    <div className="bg-gray-300 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col h-full">
      {/* Optional Image Area */}
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-auto pt-4 border-t border-gray-100">
          <button
            ...
            className="inline-flex items-center px-3 py-1.5 text-sm bg-[#1a2238] text-white rounded-md hover:bg-[#1a2238] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1a2238]"
          >
            See More
          ...
          {isOwner && (
            <button
              ...
              className="inline flex items-center px-3 py-1.5 text-sm bg-red-500 text-white hover:text-white border border-red-500 hover:bg-red-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
