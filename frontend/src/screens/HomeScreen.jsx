    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {/* ... New Recipe Box ... */}
          {/* ... Favorites Box ... */}
          <div className="p-4 md:p-6 rounded-lg shadow-md bg-gray-300 hover:shadow-lg transition-shadow duration-200">
            {" "}
            <div
            ...
            >
              {" "}
              <div className="bg-[#1a2238] p-3 rounded-full">
                {" "}
          ...
          <div
            className="bg-gray-300 p-4 md:p-6 rounded-lg shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-200"
        ...
        <div className="bg-gray-300 p-4 md:p-6 rounded-t-lg shadow-md mb-0.5">
