        ...
        <div className="w-full md:w-2/3">
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
            ...
            <div className="flex items-center pb-6 border-b border-slate-200">
              <div className="flex-shrink-0 h-16 w-16 md:h-20 md:w-20 bg-[#1a2238] from-[#1a2238] to-[#1a2238] rounded-full flex items-center justify-center text-white text-2xl md:text-3xl font-semibold mr-4 md:mr-6 shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 py-6 border-b border-slate-200">
              {/* Stat Item 1 */}
              <div className="bg-gray-300 border border-slate-200 p-4 rounded-lg flex items-center transition hover:shadow-md">
                <MenuBook
            ...
            {/* --- Danger Zone --- */}
            <div className="pt-8">
              <div className="bg-gray-300 p-5 rounded-lg border border-red-200 space-y-5">
                {/* Delete Account Row */}
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-t border-red-200 pt-5">
                  ...
                  <button
                    ...
                    className="bg-green-500 text-slate-700 px-5 py-2 rounded-md text-sm font-medium hover:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400 transition duration-200 flex-shrink-0 w-full sm:w-auto"
                  >
                    Logout
                  </button>
                </div>
